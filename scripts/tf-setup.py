...
MCP_SERVERS = {
    ...
    "spyglass-engine-ablation": ("http://localhost:8794/mcp",
                                 "ABLATION A1 (benchmark): the Spyglass evidence engine with novelty disabled -- no novel_templates, no template candidates in build_evidence_bundle, w_n = 0. Everything else identical: detect_changepoints, error_delta, deploy_events, search_logs, get_evidence, get_exemplar_request + replay_exemplar, verify_recovery."),
