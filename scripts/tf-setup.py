...
MCP_SERVERS = {
    "spyglass-engine": ("http://localhost:8791/mcp",
                        "Spyglass evidence engine (read-only): bounded, template-grouped, evidence-id-stamped tools -- novel_templates, detect_changepoints, error_delta, deploy_events, search_logs, freshness_watermark, get_evidence, service_topology."),
