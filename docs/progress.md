...
**Schedule position after P8:** Sat 15:55 IST vs the spec's Sat 18:00 —
about two hours ahead. ~30 h to the internal deadline. Next: hardening
(P9: system-minted idempotency key, approval timeout, verification
escalation paths, double-fire and approve-after-manual-rollback tests),
benchmark (P10: S2, S3, the runner, `report.py`), demo and submission (P11).
