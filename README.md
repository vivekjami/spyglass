...
**Presenting it:** [`docs/presentation.md`](docs/presentation.md) — the story spine, the deck ([`docs/deck/index.html`](docs/deck/index.html)), the second-by-second cut, the narration script, the with/without comparison stated honestly, and the judge Q&A. **Filming it:** [`docs/demo-day.md`](docs/demo-day.md) — setup from a cold machine, recorder setup, the four captures, the ffmpeg recipes, and what to do when a take goes wrong.
